...
- A number system with a base (radix) $8$ is called Octal Number System and uses
  the following digits $0, 1, 2, 3, 4, 5, 6, 7$.
...
- The digit positions to the left of the octal point represent, $8^0, 8^1, 8^2,
  8^3, \cdots$ and the digit positions to the right of the octal point represent
  $8^{(-1)}, 8^{(-2)}, 8^{(-3)}, \cdots$.
...
1. $234_{(10)}$
   ...
   $234_{(10)} \to \\ 234|{ \color{green} 2 } \to 234 \div 8 = 29.25; \qquad rem
   = { 0.25 \times 8 = \color{green} 2}; LSD\text{(most left digit)} \\ \;\;
...
5. $4563.419_{(10)}$
   ...
   $4563_{(10)} \to \\ 4563|{ \color{green} 3 } \to 4563 \div 8 = 570.375; \quad
   rem = { 0.375 \times 8 = \color{green} 3}; LSD \text{(most left digit)} \\
   \;\;570|{ \color{green} 2 } \to \;\; 570 \div 8 = 71.25; \qquad rem = { 0.25
   \times 8 = \color{green} 2 } \\ \quad 71|{ \color{green} 7 } \to \;\; \;\; 71
   \div 8 = 8.875; \qquad rem = { 0.875 \times 8 = \color{green} 7 } \\ \quad
   \;\;8|{ \color{green} 0 } \to \;\; \quad 8 \div 8 = 1; \qquad \qquad rem = {
   0.0 \times 8 = \color{green} 0 } \\ \quad \;\;1|{ \color{green} 1 } \to
   \quad\;\; 1 \div 8 = \ \cdots; \quad \qquad rem = \cdots = { \color{green} 1
   }; MSD\text{(most right digit)} \\ 4563_{(10)} = { \color{pink} 10723_{(8)}
   }$
