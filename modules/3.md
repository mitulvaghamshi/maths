...
- A number system with a base (radix) $2$ is called **Binary Number System** and
...
- The digit positions to the left of the binary point represent $2^0, 2^1, 2^2,
  2^3, \cdots$ (going backwards) and the digit positions $s$ to the right of the
  binary point represent $2^{-1}, 2^{-2}, 2^{-3}$
...
1. $10111_{(2)} =$
   ...
   $\begin{equation} 10111_{(2)} \to \cfrac{\begin{array}{r} 1 \\ \times 2
   \end{array}} { \cfrac{\begin{array}{r} 2 + 0 = 2 \\ \times 2 \end{array}} {
   \cfrac{\begin{array}{r} 4 + 1 = 5 \\ \times 2 \end{array}} {
   \cfrac{\begin{array}{r} 10 + 1 = 11 \\ \times 2 \end{array}} {
...
2. $110011101_{(2)} =$
   ...
   $\begin{equation} 110011101_{(2)} \to \cfrac{\begin{array}{r} 1 \\ \times 2
   \end{array}} { \cfrac{\begin{array}{r} 2 + 1 = 3 \\ \times 2 \end{array}} {
   \cfrac{\begin{array}{r} 6 + 0 = 6 \\ \times 2 \end{array}} {
   \cfrac{\begin{array}{r} 12 + 0 = 12 \\ \times 2 \end{array}} {
   \cfrac{\begin{array}{r} 24 + 1 = 25 \\ \times 2 \end{array}} {
   \cfrac{\begin{array}{r} 50 + 1 = 51 \\ \times 2 \end{array}} {
   \cfrac{\begin{array}{r} 102 + 1 = 103 \\ \times 2 \end{array}} {
   \cfrac{\begin{array}{r} 206 + 0 = 206 \\ \times 2 \end{array}} {
...
3. $0.11101_{(2)} =$
   ...
   $\begin{equation} 0.11101_{(2)} \to \cfrac{\begin{array}{r} 1 \\ \div 2
   \end{array}} { \cfrac{\begin{array}{r} 0 + 0.5 = 0.5 \\ \div 2 \end{array}} {
   \cfrac{\begin{array}{r} 1 + 0.25 = 1.25 \\ \div 2 \end{array}} {
   \cfrac{\begin{array}{r} 1 + 0.625 = 1.625 \\ \div 2 \end{array}} {
   \cfrac{\begin{array}{r} 1 + 0.8125 = 1.8125 \\ \div 2 \end{array}} {
...
4. $11011.0111_{(2)} =$
   ...
   $\begin{equation} 11011_{(2)} \to \cfrac{\begin{array}{r} 1 \\ \times 2
   \end{array}} { \cfrac{\begin{array}{r} 2 + 1 = 3 \\ \times 2 \end{array}} {
   \cfrac{\begin{array}{r} 6 + 0 = 6 \\ \times 2 \end{array}} {
   \cfrac{\begin{array}{r} 12 + 1 = 13 \\ \times 2 \end{array}} {
   \begin{array}{r} 26 + 1 = { \color{green} 27 } \end{array} } } } } \cdot
   0111_{(2)} \to \cfrac{\begin{array}{r} 1 \\ \div 2 \end{array}} {
   \cfrac{\begin{array}{r} 1 + 0.5 = 1.5 \\ \div 2 \end{array}} {
   \cfrac{\begin{array}{r} 1 + 0.75 = 1.75 \\ \div 2 \end{array}} {
   \cfrac{\begin{array}{r} 0 + 0.875 = 0.875 \\ \div 2 \end{array}} {
   \begin{array}{r} { \color{green} 0.4375 } \end{array} } } } } \end{equation}$
   <h3>

   $11011.0111_{(2)} = { \color{green} 27.4375_{(10)} }$
   </h3>
    </details>
     <hr />
...
- Numbers given in decimal number system can be converted into binary number
  system.
...
- The final binary answer is made up of all remainders written in opposite way;
  ...
  digit - MSD).
- For example, to convert $53_{(10)}$ to its binary equivalent we have: $\\ 53|{
  \color{green} 1 } \to 53 \div 2 = 26; \; rem = { \color{green} 1 };
...
1. $145_{(10)} =$
   ...
   $\\ 145|{ \color{green} 1 } \to 145 \div 2 = 72; \; rem = { \color{green} 1
   }; LSD\text{(most left digit)} \\ \;\;72|{ \color{green} 0 } \to \;\;72 \div
   2 = 36; \; rem = { \color{green} 0 } \\ \;\;36|{ \color{green} 0 } \to \;\;36
   \div 2 = 18; \; rem = { \color{green} 0 } \\ \;\;18|{ \color{green} 0 } \to
   \;\;18 \div 2 = \;\;9; \; rem = { \color{green} 0 } \\ \;\;\;\;9|{
   \color{green} 1 } \to \;\;\;\;9 \div 2 = \;\;4; \; rem = { \color{green} 1 }
   \\ \;\;\;\;4|{ \color{green} 0 } \to \;\;\;\;4 \div 2 = \;\;2; \; rem = {
   \color{green} 0 } \\ \;\;\;\;2|{ \color{green} 0 } \to \;\;\;\;2 \div 2 =
   \;\;1; \; rem = { \color{green} 0 } \\ \;\;\;\;1|{ \color{green} 1 } \to
   \;\;\;\;1 \div 2 = \;\;\equiv; \; rem = { \color{green} 1 }; MSD\text{(most
   right digit)} \\$
   <h3>
...
2. $6712_{(10)} =$
   ...
   $\\ 6712|{ \color{green} 0 } \to 6712 \div 2 = 3356; \; rem = { \color{green}
   0 }; LSD\text{(most left digit)} \\ 3356|{ \color{green} 0 } \to 3356 \div 2
   = 1678; \; rem = { \color{green} 0 } \\ 1678|{ \color{green} 0 } \to 1678
   \div 2 = \;\;839; \; rem = { \color{green} 0 } \\ \;\;839|{ \color{green} 1 }
   \to \;\;839 \div 2 = \;\;419; \; rem = { \color{green} 1 } \\ \;\;419|{
   \color{green} 1 } \to \;\;419 \div 2 = \;\;209; \; rem = { \color{green} 0 }
   \\ \;\;209|{ \color{green} 1 } \to \;\;209 \div 2 = \;\;104; \; rem = {
   \color{green} 1 } \\ \;\;104|{ \color{green} 0 } \to \;\;104 \div 2 =
   \;\;\;\;52; \; rem = { \color{green} 0 } \\ \;\;\;52|{ \color{green} 0 } \to
   \;\;\;\;\;52 \div 2 = \;\;\;\;26; \; rem = { \color{green} 0 } \\ \;\;\;26|{
   \color{green} 0 } \to \;\;\;\;\;26 \div 2 = \;\;\;\;13; \; rem = {
   \color{green} 0 } \\ \;\;\;13|{ \color{green} 1 } \to \;\;\;\;\;13 \div 2 =
   \;\;\;\;\;\;6; \; rem = { \color{green} 1 } \\ \;\;\;\;\;6|{ \color{green} 0
   } \to \;\;\;\;\;\;\;6 \div 2 = \;\;\;\;\;\;3; \; rem = { \color{green} 0 } \\
   \;\;\;\;\;3|{ \color{green} 1 } \to \;\;\;\;\;\;\;3 \div 2 = \;\;\;\;\;\;1;
   \; rem = { \color{green} 1 } \\ \;\;\;\;\;1|{ \color{green} 1 } \to
   \;\;\;\;\;\;\;1 \div 2 = \;\;\;\;\;\;\equiv; \; rem = { \color{green} 1 };
...
3. $0.75_{(10)} =$
   ...
   \color{green} 1 }|50 \to 0.50 * 2 = { \color{green} 1 }.00 \\ { \color{green}
   1 }|00 \to 0.00 * 2 = \cdots$
   <h3>
...
5. $971.419_{(10)} \text{(to 6 places after the fractional point)} =$
   ...
   $\\ 971|{ \color{green} 1 } \to 971 \div 2 = 435; \; rem = { \color{green} 1
   }; LSD\text{(most left digit)} \\ 435|{ \color{green} 1 } \to 435 \div 2 =
   242; \; rem = { \color{green} 1 } \\ 242|{ \color{green} 0 } \to 242 \div 2 =
   121; \; rem = { \color{green} 0 } \\ 121|{ \color{green} 1 } \to 121 \div 2 =
   \;\;60; \; rem = { \color{green} 1 } \\ \;\;60|{ \color{green} 0 } \to \;\;60
   \div 2 = \;\;30; \; rem = { \color{green} 0 } \\ \;\;30|{ \color{green} 0 }
   \to \;\;30 \div 2 = \;\;15; \; rem = { \color{green} 0 } \\ \;\;15|{
   \color{green} 1 } \to \;\;15 \div 2 = \;\;\;\;7; \; rem = { \color{green} 1 }
   \\ \;\;\;\;7|{ \color{green} 1 } \to \;\;\;\;7 \div 2 = \;\;\;\;3; \; rem = {
   \color{green} 1 } \\ \;\;\;\;3|{ \color{green} 1 } \to \;\;\;\;3 \div 2 =
   \;\;\;\;1; \; rem = { \color{green} 1 } \\ \;\;\;\;1|{ \color{green} 1 } \to
   \;\;\;\;1 \div 2 = \;\;\;\;\equiv; \; rem = { \color{green} 1 };
   MSD\text{(most right digit)} \\ = { 971 = \color{pink} 1111001011_{(2)} }$
   ...
   \color{green} 0 }|816 \to 0.816 * 2 = { \color{green} \cdots } \\ = { 0.419 =
   \color{pink} 0.011010_{(2)} }$
   <h3>
...
6. $203.24_{(10)} \text{(to 6 places after the fractional point)} =$
   ...
   $\\ 203|{ \color{green} 1 } \to 203 \div 2 = 101; \; rem = { \color{green} 1
   }; LSD\text{(most left digit)} \\ 101|{ \color{green} 1 } \to 101 \div 2 =
   \;\;50; \; rem = { \color{green} 1 } \\ \;\;50|{ \color{green} 0 } \to \;\;50
   \div 2 = \;\;25; \; rem = { \color{green} 0 } \\ \;\;25|{ \color{green} 1 }
   \to \;\;25 \div 2 = \;\;12; \; rem = { \color{green} 1 } \\ \;\;12|{
   \color{green} 0 } \to \;\;12 \div 2 = \;\;\;\;6; \; rem = { \color{green} 0 }
   \\ \;\;\;\;6|{ \color{green} 0 } \to \;\;\;\;6 \div 2 = \;\;\;\;3; \; rem = {
   \color{green} 0 } \\ \;\;\;\;3|{ \color{green} 1 } \to \;\;\;\;3 \div 2 =
   \;\;\;\;1; \; rem = { \color{green} 1 } \\ \;\;\;\;1|{ \color{green} 1 } \to
   \;\;\;\;1 \div 2 = \;\;\;\;\equiv; \; rem = { \color{green} 1 };
   MSD\text{(most right digit)} \\ = { 203 = \color{pink} 11001011_{(2)} }$

   $\\ \;{ \color{green} .}|24 \to 0.24 * 2 = { \color{green} 0 }.48 \\ {
   \color{green} 0 }|48 \to 0.48 * 2 = { \color{green} 0 }.96 \\ { \color{green}
   0 }|96 \to 0.96 * 2 = { \color{green} 1 }.92 \\ { \color{green} 1 }|92 \to
   0.92 * 2 = { \color{green} 1 }.84 \\ { \color{green} 1 }|84 \to 0.84 * 2 = {
   \color{green} 1 }.68 \\ { \color{green} 1 }|68 \to 0.68 * 2 = { \color{green}
   1 }.36 \\ { \color{green} 1 }|36 \to 0.36 * 2 = { \color{green} \cdots } \\ =
...
7. $5279.635_{(10)} \text{(to 6 places after the fractional point)} =$
   ...
   $\\ 5279|{ \color{green} 1 } \to 5279 \div 2 = 2639; \; rem = { \color{green}
   1 }; LSD\text{(most left digit)} \\ 2639|{ \color{green} 1 } \to 2639 \div 2
   = 1319; \; rem = { \color{green} 1 } \\ 1319|{ \color{green} 1 } \to 1319
   \div 2 = \;\;659; \; rem = { \color{green} 1 } \\ \;\;659|{ \color{green} 1 }
   \to \;\;659 \div 2 = \;\;329; \; rem = { \color{green} 1 } \\ \;\;329|{
   \color{green} 1 } \to \;\;329 \div 2 = \;\;164; \; rem = { \color{green} 1 }
   \\ \;\;164|{ \color{green} 0 } \to \;\;164 \div 2 = \;\;\;\;82; \; rem = {
   \color{green} 0 } \\ \;\;\;\;82|{ \color{green} 0 } \to \;\;\;\;82 \div 2 =
   \;\;\;\;41; \; rem = { \color{green} 0 } \\ \;\;\;\;41|{ \color{green} 1 }
   \to \;\;\;\;41 \div 2 = \;\;\;\;20; \; rem = { \color{green} 1 } \\
   \;\;\;\;20|{ \color{green} 0 } \to \;\;\;\;20 \div 2 = \;\;\;\;10; \; rem = {
   \color{green} 0 } \\ \;\;\;\;10|{ \color{green} 0 } \to \;\;\;\;10 \div 2 =
   \;\;\;\;\;\;5; \; rem = { \color{green} 0 } \\ \;\;\;\;\;\;5|{ \color{green}
   1 } \to \;\;\;\;\;\;5 \div 2 = \;\;\;\;\;\;2; \; rem = { \color{green} 1 } \\
   \;\;\;\;\;\;2|{ \color{green} 0 } \to \;\;\;\;\;\;2 \div 2 = \;\;\;\;\;\;1;
   \; rem = { \color{green} 0 } \\ \;\;\;\;\;\;1|{ \color{green} 1 } \to
   \;\;\;\;\;\;1 \div 2 = \;\;\;\;\;\;\equiv; \; rem = { \color{green} 1 };
   MSD\text{(most right digit)} \\ = { 5279 = \color{pink} 1010010011111_{(2)}
   }$
   ...
   \color{green} 0 }|640 \to 0.640 * 2 = { \color{green} \cdots } \\ = { 0.635 =
   \color{pink} 0.101000_{(2)} }$
   <h3>
...
8. $83149.3282_{(10)} \text{(to 6 places after the fractional point)} =$
   ...
   $\\ 83149|{ \color{green} 1 } \to 83149 \div 2 = 41574; \; rem = {
   \color{green} 1 }; LSD\text{(most left digit)} \\ 41574|{ \color{green} 0 }
   \to 41574 \div 2 = 20787; \; rem = { \color{green} 0 } \\ 20787|{
   \color{green} 1 } \to 20787 \div 2 = 10393; \; rem = { \color{green} 1 } \\
   10393|{ \color{green} 1 } \to 10393 \div 2 = \;\;5196; \; rem = {
   \color{green} 1 } \\ \;\;5196|{ \color{green} 0 } \to \;\;5196 \div 2 =
   \;\;2598; \; rem = { \color{green} 0 } \\ \;\;2598|{ \color{green} 0 } \to
   \;\;2598 \div 2 = \;\;1299; \; rem = { \color{green} 0 } \\ \;\;1299|{
   \color{green} 1 } \to \;\;1299 \div 2 = \;\;\;\;649; \; rem = { \color{green}
   1 } \\ \;\;\;\;649|{ \color{green} 1 } \to \;\;\;\;649 \div 2 = \;\;\;\;324;
   \; rem = { \color{green} 1 } \\ \;\;\;\;324|{ \color{green} 0 } \to
   \;\;\;\;324 \div 2 = \;\;\;\;162; \; rem = { \color{green} 0 } \\
   \;\;\;\;162|{ \color{green} 0 } \to \;\;\;\;162 \div 2 = \;\;\;\;\;\;81; \;
   rem = { \color{green} 0 } \\ \;\;\;\;\;\;81|{ \color{green} 1 } \to
   \;\;\;\;\;\;81 \div 2 = \;\;\;\;\;\;40; \; rem = { \color{green} 1 } \\
   \;\;\;\;\;\;40|{ \color{green} 0 } \to \;\;\;\;\;\;40 \div 2 =
   \;\;\;\;\;\;20; \; rem = { \color{green} 0 } \\ \;\;\;\;\;\;20|{
   \color{green} 0 } \to \;\;\;\;\;\;20 \div 2 = \;\;\;\;\;\;10; \; rem = {
   \color{green} 0 } \\ \;\;\;\;\;\;10|{ \color{green} 0 } \to \;\;\;\;\;\;10
   \div 2 = \;\;\;\;\;\;\;\;5; \; rem = { \color{green} 0 } \\
   \;\;\;\;\;\;\;\;5|{ \color{green} 1 } \to \;\;\;\;\;\;\;\;5 \div 2 =
   \;\;\;\;\;\;\;\;2; \; rem = { \color{green} 1 } \\ \;\;\;\;\;\;\;\;2|{
   \color{green} 0 } \to \;\;\;\;\;\;\;\;2 \div 2 = \;\;\;\;\;\;\;\;1; \; rem =
   { \color{green} 0 } \\ \;\;\;\;\;\;\;\;1|{ \color{green} 1 } \to
   \;\;\;\;\;\;\;\;1 \div 2 = \;\;\;\;\;\;\;\;\equiv; \; rem = { \color{green} 1
   }; MSD\text{(most right digit)} \\ = { 83149 = \color{pink}
   10100010011001101_{(2)} }$
